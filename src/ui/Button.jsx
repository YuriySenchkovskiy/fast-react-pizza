...
function Button ({children, disabled, to, type, onClick}) {
    ...
    const styles = {
        ...
        secondary: "border-2 text-sm border-stone-300 uppercase font-semibold text-stone-400 inline-block " +
            "tracking-wide rounded-full hover:bg-stone-300 transition-colors duration-300 " +
            "focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 " +
            "disabled:cursor-not-allowed py-2.5 px-4 md:px-6 md:py-3.5 hover:text-stone-800" +
